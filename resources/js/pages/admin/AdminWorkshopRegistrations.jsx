                ...
                <div className="view-modal" dir="rtl">
                    <div className="view-modal-content">
                        <div className="view-modal-header">
                            <h3 className="view-modal-title">تفاصيل تسجيل الورشة</h3>
                            <button
                        ...
                        <div className="view-modal-body">
                            ...
                            <div className="view-modal-field">
                                <label className="view-modal-label">الورشة</label>
                                <div className="view-modal-value">{selectedRegistration.workshop?.title || 'غير محدد'}</div>
                            </div>
                            <div className="view-modal-field">
                                <label className="view-modal-label">المدرب</label>
                                <div className="view-modal-value">{selectedRegistration.workshop?.instructor || 'غير محدد'}</div>
                            </div>
                            <div className="view-modal-field">
