    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50">
            ...
            <div className="py-8 lg:py-12 xl:py-16">
                <div className="max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
                    {loadingRegistration ? (
                        <div className="flex justify-center items-center py-12 lg:py-16">
                            <div className="animate-spin rounded-full h-8 w-8 lg:h-12 lg:w-12 border-b-2 border-green-600"></div>
                        ...
                        <div className="bg-white rounded-xl lg:rounded-2xl xl:rounded-3xl shadow-2xl overflow-hidden transition-transform duration-300">
                            <div className="h-2 lg:h-3" style={{background: 'linear-gradient(90deg, #F4A321 0%, #D85584 50%, #096289 100%)'}}></div>
                            <div className="p-4 lg:p-6 xl:p-8">
                                <div className="text-center mb-4 lg:mb-6 xl:mb-8">
                                    <div className="flex justify-center mb-3 lg:mb-4">
                                        <div className="bg-gradient-to-r from-green-500 to-teal-500 text-white p-3 lg:p-4 xl:p-5 rounded-xl lg:rounded-2xl shadow-lg">
