                ...
                <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 h-3"></div>
                    <div className="p-8 lg:p-12">
                        <div className="flex items-center mb-8">
                            <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 rounded-2xl mr-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 p-4 rounded-2xl border border-orange-100 hover:shadow-md transition-shadow duration-200">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-gray-900 font-medium">{registration.age}</span>
                                        </div>
                                    </div>
                                    
                                    <div className="bg-gradient-to-r from-teal-50 to-cyan-50 p-4 rounded-2xl border border-teal-100 hover:shadow-md transition-shadow duration-200">
                                        <div className="flex justify-between items-center">
                                            <span className="font-semibold text-gray-700 flex items-center">
                                                <span className="mr-2">📍</span>
                                                {language === 'ar' ? 'المدينة:' : 'City:'}
                                            </span>
                                            <span className="text-gray-900 font-medium">{registration.city}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-2xl border border-pink-100 hover:shadow-md transition-shadow duration-200">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {registration.skills && registration.skills.map((skill, index) => (
                                                <span key={index} className="bg-white/50 px-3 py-1 rounded-full text-sm font-medium text-gray-900 border border-pink-200">
                                                    {getSkillsText([skill])}
                                                </span>
                                            ))}
                                        </div>
                        ...
                        <div className="mt-8 space-y-6">
                            ...
                            {registration.project_idea && (
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-200 hover:shadow-md transition-shadow duration-200">
                                    <div className="flex items-center mb-4">
                                    ...
                                    <p className="text-blue-700 font-medium bg-white/50 px-4 py-3 rounded-lg">
                                        {registration.project_idea}
                                    </p>
                                </div>
                            )}
