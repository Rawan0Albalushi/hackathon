		...
		<div className="max-w-5xl mx-auto overflow-x-hidden">
			...
			<div className={`${statusConfig.bg} ${statusConfig.text} rounded-3xl p-5 sm:p-8 mb-6 sm:mb-8 shadow-2xl relative overflow-hidden`}>
				...
				<div className="relative z-10">
					<div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 sm:gap-6 rtl:space-x-reverse">
			...
			<div className="bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 animate-in slide-in-from-top-4">
				...
				<div className="p-5 sm:p-8 lg:p-12">
					<div className="flex items-center mb-6 sm:mb-8">
						<div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-3 sm:p-4 rounded-2xl mr-3 sm:mr-4">
			...
			{registration.status === 'approved' && (
				<div className="mt-6 sm:mt-8 space-y-6 sm:space-y-8">
						...
						<div className="p-5 sm:p-8 lg:p-12">
							<div className="text-center mb-6 sm:mb-8">
								<div className="flex justify-center mb-3 sm:mb-4">
									<div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-3 sm:p-4 rounded-2xl shadow-lg">
								...
								<p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto">
									{language === 'ar' 
										? 'احتفظ بهذا QR Code لتسهيل عملية التسجيل والدخول للورشة'
										: 'Keep this QR Code for easy registration and workshop access'}
								</p>
							</div>
					...
					<div className="mt-6 sm:mt-8 text-center hidden sm:block">
								<div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-5 sm:p-6 rounded-2xl border border-blue-200">
									...
									<div className="space-y-1.5 sm:space-y-2 text-blue-700">
										...
										<p className="flex items-center justify-center space-x-2 rtl:space-x-reverse text-sm sm:text-base">
											<span>2️⃣</span>
											<span>{language === 'ar' ? 'أظهرها عند وصولك للورشة' : 'Show it when you arrive at the workshop'}</span>
										</p>
										<p className="flex items-center justify-center space-x-2 rtl:space-x-reverse text-sm sm:text-base">
											<span>3️⃣</span>
