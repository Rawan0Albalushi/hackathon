            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 animate-in slide-in-from-top-4">
                ...
                <div className="p-8 lg:p-12">
                    <div className="flex items-center mb-8">
                        <div className="bg-gradient-to-r from-green-500 to-teal-500 text-white p-4 rounded-2xl mr-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                {registration.organization && (
                                    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 p-4 rounded-2xl border border-orange-100 hover:shadow-md transition-shadow duration-200">
                                        <div className="flex justify-between items-center">
                                            <span className="font-semibold text-gray-700 flex items-center">
                                                <span className="mr-2">🏢</span>
                                                {language === 'ar' ? 'المؤسسة:' : 'Organization:'}
                                            </span>
                                            <span className="text-gray-900 font-medium">{registration.organization}</span>
                                        </div>
                                    </div>
                                )}
                            </div>
